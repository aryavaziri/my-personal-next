...
// import IMG1 from "@../public/images/test1.jpg";
...
const page = () => {
    return (
        <div className={`border-vr1 text-slate-200 bg-vr relative w-screen font-custom2 px-4 sm:px-20 md:px-28 pb-12 duration-500 text-lg `} >
            ...
            <h1
                className={` px-12 max-md:text-center md:px-4 pt-10 pb-2 text-4xl sm:text-6xl font-bold border-b-2 sticky top-0 backdrop-blur-md`}
            >
            ...
            <div className="flex sm:justify-between max-md:flex-col my-6">
                <div className="basis-1/3 flex flex-col gap-2 p-2">
                    <div className="flex gap-2 items-baseline">
                        <div
                            className={` w-24 font-bold text-right text-xl px-2`}
                        >
                            Techsnologies:
                        </div>
                        <div className="px-2">
                    ...
                    <div className="flex gap-2 items-baseline">
                        <div
                            className={`${`border-poker text-poker`
                                } w-24 font-bold text-right text-xl px-2`}
                        >
                            Date:
                        </div>
                ...
                <div className="basis-2/3 p-2 font-[500] text-2xl">
                    Casinoa, is a dynamic and interactive platform built using Django and
                    React. The project leverages the Django framework on the server-side,
                    handling the game logic, database management, and user authentication.
                    React, on the other hand, powers the dynamic frontend, delivering a
                    seamless and responsive user interface.{" "}
                </div>
            </div>
            <div className="my-12">
                <div
                    className={` border-b-2 text-3xl p-2 font-bold mb-6`}
                >
                    Concept
                </div>
                <p className="text-justify">
                    ...
                    underlying database, making it an ideal choice for creating a platform
                    that can support the development of an AI player.
                    <br />
                    While the AI player development is still in progress, the current
                    iteration of the Poker Web Application offers an exciting multiplayer
                    experience with virtual currency. Users can create personalized
                    accounts, participate in multiplayer games, and compete against
                    friends or other players online.
                    <br />
                    By providing a platform for multiplayer gameplay, this project allows
                    players to engage in exciting poker matches using virtual money. This
                    multiplayer functionality serves as a foundation for gathering
                    valuable data, which will be instrumental in refining the AI player's
                    strategy and improving its performance over time.
                </p>
            </div>
            <div className="my-8">
                <div
                    className={` border-b-2 text-3xl p-2 font-bold `}
                >
                    Key Features
                </div>
