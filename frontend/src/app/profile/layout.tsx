...
const Layout = ({ children }: React.PropsWithChildren) => {
  return (
    <div className={`relative min-h-screen w-screen overflow-hidden`}>
      <div className="pr-4 pl-6 sm:pl-20 md:pl-56 lg:pl-56 backdrop-blur z-[4] w-full font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl fixed pt-6 sm:pt-10 pb-3">
        <Link
          href={`/profile`}
