...
export default function Page() {
  ...
  return (
    <>
      ...
      {/* <SketchComponent3 /> */}
      <div className="absolute left-0 top-0 w-screen h-screen blur-[0px] z-[-99] ">
        <SketchComponent2 />
        {/* <div className="absolute left-0 top-0 w-screen h-screen blur-[0px] z-[-99] bg-gradient-to-b from-30% from-[#B8F2E6] to-transparent "> */}
